...
public class bed extends GenLayerHills
{
    public bed(long worldIn, GenLayerHills chunkX)
    {
        super(worldIn);
        super.a = chunkX;
    }
    ...
    public int[] getInts(int areaX, int areaY, int areaWidth, int areaHeight)
    {
        ...
        int[] aint = this.a.getInts(i, j, k, l);
        int i1 = k - 1 << 1;
        int j1 = l - 1 << 1;
        int[] aint1 = GenLayer.a(i1 * j1);
        ...
        int[] aint2 = GenLayer.a(areaWidth * areaHeight);
    ...
    public static GenLayerHills b(long p_b_0_, GenLayerHills p_b_2_, int p_b_3_)
    {
        GenLayerHills genlayerhills = p_b_2_;

        for (int i = 0; i < p_b_3_; ++i)
        {
            genlayerhills = new bed(p_b_0_ + (long)i, genlayerhills);
        }
