...
public class Shader
{
    ...
    public void loadShader(float p_148042_1_)
    {
        ...
        if(BlurBufferMod.getBlurShaderGroup() != null) {
        	if(minecraft.currentScreen instanceof GuiIngameMenu || minecraft.currentScreen instanceof GuiJigsawWelcome || minecraft.currentScreen instanceof GuiJigsawHackerDetect) {
        		this.manager.getShaderUniformOrDefault("InSize").set((float)this.framebufferIn.framebufferTextureWidth, (float)this.framebufferIn.framebufferTextureHeight); //TODO Jigsaw optimise blur!
        	}
        	else {
        		this.manager.getShaderUniformOrDefault("InSize").set((float)this.framebufferIn.framebufferTextureWidth / 3, (float)this.framebufferIn.framebufferTextureHeight / 3); //TODO Jigsaw optimise blur!
        	}
