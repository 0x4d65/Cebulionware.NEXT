...
public class GuiIngameMenu extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        if (!Jigsaw.ghostMode) {
			this.buttonList.add(new GuiButton(69, this.width / 2 - 100, this.height / 4 + 48 + i + 24, Jigsaw.getClientName().split(" ")[0]));
			
			this.buttonList.add(new GuiButton(1337, width - 150, 0, 150, 20, "Display welcome message", true));
		}
    }
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        switch (button.id)
        {
            ...
            case 1337:
            	...
            	this.mc.displayGuiScreen(new GuiJigsawWelcome(this));
            default:
                break;
        }
    }
