...
public class GuiJigsawOpenLinkFailed extends GuiScreen {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		drawCenteredString(fontRenderer, "Failed to open link!", width / 2, height / 2 - 60, 0xffffff);
		drawCenteredString(fontRenderer, "You have to download it manually from the website:", width / 2,
				height / 2 - 50, 0xffffff);

		drawCenteredString(fontRenderer, "http://jigsawclient.weebly.com/download.html", width / 2, height / 2 - 40,
				0xffffff);
