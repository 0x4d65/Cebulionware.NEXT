...
public class GuiJigsawKeyBind extends GuiScreen {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		this.drawCenteredString(this.fontRenderer, "Press a key...", width / 2, height / 2 + offset, 0xffffff);
		this.drawCenteredString(this.fontRenderer, "or", width / 2, height / 2 + offset + 20, 0xffffff);
		GlStateManager.pushMatrix();
		GlStateManager.scale(3, 3, 0);
		this.drawCenteredString(this.fontRenderer, "KeyBind - §6" + module.getName(), width / 2 / 3,
