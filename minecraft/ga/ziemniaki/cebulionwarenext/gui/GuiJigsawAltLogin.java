...
public class GuiJigsawAltLogin extends GuiScreen {
	...
	public void initGui() {
		...
		emailField = new GuiTextField(2, this.fontRenderer, this.width / 2 - 100, this.height / 2 - 10, 200, 20);
		emailField.setMaxStringLength(254);
		emailField.setFocused(true);

		passwordField = new GuiPasswordField(3, this.fontRenderer, this.width / 2 - 100, this.height / 2 + 25, 200, 20);
	}
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		this.fontRenderer.drawString("§7E-mail / Username: ", this.width / 2 - 100, this.height / 2 - 21, 0xffffff);
		this.fontRenderer.drawString("§7Password: ", this.width / 2 - 100, this.height / 2 + 14, 0xffffff);
		drawCenteredString(fontRenderer, "§c(Leave password blank for cracked login)", this.width / 2,
				this.height / 2 + 50, 0xffffff);
		GlStateManager.scale(4, 4, 1);
		drawCenteredString(fontRenderer, "Alt Login", this.width / 2 / 4, (this.height / 2 - 100) / 4, 0xffffff);
