...
public class GuiJigsawIpResolver extends GuiScreen {
	...
	public void initGui() {
		...
		userField = new GuiTextField(2, this.fontRenderer, this.width / 2 - 100, this.height / 2 + 10 - offset, 100, 20);
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		drawCenteredString(fontRenderer, "§7IP Resolver", this.width / 2 / 2, (this.height / 2 - 25 - offset) / 2, 0xffffffff);
		drawCenteredString(fontRenderer, "§6" + result, (this.width / 2) / 2, (this.height / 2 + 42 - offset) / 2, 0xffffffff);
		GlStateManager.scale(0.5, 0.5, 1);
		drawHorizontalLine((this.width / 2 - 60) / 1, (this.width / 2 - 80 + 138) / 1, (this.height / 2 - 5 - offset) / 1, 0xffaaaaaa);
		drawString(fontRenderer, "§7MC Username:", this.width / 2 - 100, this.height / 2 - offset, 0xffffffff);
