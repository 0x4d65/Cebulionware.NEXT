...
public class GuiJigsawAdvanced extends GuiScreen {
	...
	public void initGui() {
		...
		this.buttonList.add(new GuiButton(9, this.width / 2 - 80, this.height / 2 + 22, 160, 20, "Reload Fonts"));
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		drawCenteredString(fontRenderer, Jigsaw.headerNoBrackets, this.width / 2 / 4, (this.height / 2 - 67) / 4, 0xffffffff);
		GlStateManager.scale(0.5, 0.5, 1);
		drawCenteredString(fontRenderer, "§7Advanced", this.width / 2 / 2, (this.height / 2 - 25) / 2, 0xffffffff);
		GlStateManager.scale(0.5, 0.5, 1);
